...
Je vois régulièrement des personnes investir dans un micro à plus de 100€ et obtenir un son de mauvaise qualité parce qu'il n'est pas utilisé correctement, alors que je m'en sors très bien pour beaucoup moins cher.
...
Je conseille le modèle [opencomm](https://fr.shokz.com/products/opencomm) de Shokz qui isole vraiment bien votre voix.
...
L'EQ, ou "Equalizer", c'est le machin qui permet d'augmenter ou de baisser les sons graves et aigus (utile pour équilibrer le son d'un micro).
Pour du podcast, l'interface 16 bits fera largement l'affaire, et la plupart ne nécessitent aucun driver pour fonctionner.
