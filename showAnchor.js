// forked from https://github.com/bryanbraun/anchorjs
(function (root, factory) {
    ...
    function AnchorJS(options) {
      ...
      function _applyRemainingDefaultOptions(opts) {
        opts.icon = '\uE9CB'; // Accepts characters (and also URLs?), like  '#', '¶', '❡', or '§'.
        opts.visible = 'hover'; 
        opts.placement = 'right'; 
        opts.ariaLabel = 'Anchor'; // Accepts any text.
        opts.class = ''; // Accepts any class name.
        opts.base = ''; // Accepts any base URI.
